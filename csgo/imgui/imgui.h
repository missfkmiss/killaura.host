...
namespace ImGui
{
    ...
    IMGUI_API void          ShowDemoWindow(bool* p_open = NULL);        // create demo/test window (previously called ShowTestWindow). demonstrate most ImGui Cfgs. call this to learn about the library! try to make it always available in your application!
	...
	IMGUI_API bool          Button2(const char* label, const ImVec2& size = ImVec2(0, 0), bool active = false);    // button
	IMGUI_API bool          Button3(const char* label, const ImVec2& size = ImVec2(0, 0), bool active = false);    // button
    IMGUI_API bool          SmallButton(const char* label);                                 // button with FramePadding=(0,0) to easily embed within text
	IMGUI_API bool          SmallButton2(const char* label, bool active = false);                                 // button with FramePadding=(0,0) to easily embed within text
	IMGUI_API bool          SmallButton3(const char* label, bool active = false);                                 // button with FramePadding=(0,0) to easily embed within text
    ...
    IMGUI_API void          BeginTooltip();                                                     // begin/append a tooltip window. to create full-Cfgd tooltip (with any kind of contents).
...
// **Avoid storing ImColor! Store either u32 of ImVec4. This is not a full-Cfgd color class. MAY OBSOLETE.
