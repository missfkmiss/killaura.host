...
// You may use this file to debug, understand or extend ImGui Cfgs but we don't provide any guarantee of forward compatibility!
// Set:
...
// FIXME: this is in development, not exposed/functional as a generic Cfg yet.
...
namespace ImGui
{
	...
	IMGUI_API void          RenderTextClipped2(const ImVec2& pos_min, const ImVec2& pos_max, const char* text, const char* text_end, const ImVec2* text_size_if_known, const ImVec2& align = ImVec2(0, 0), const ImRect* clip_rect = NULL);
	...
	IMGUI_API bool          ButtonEx2(const char* label, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0, bool active = false);
	IMGUI_API bool          ButtonEx3(const char* label, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0, bool active = false);
